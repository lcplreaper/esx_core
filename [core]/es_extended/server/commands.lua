...
ESX.RegisterCommand({'car', 'sv'}, 'admin', function(xPlayer, args, showError)
...
ESX.RegisterCommand({'giveweaponcomponent', 'givecomponent'}, 'admin', function(xPlayer, args, showError)
